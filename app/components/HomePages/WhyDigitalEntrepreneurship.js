...
function WhyDigitalEntrepreneurship() {
  ...
  return (
    <section className="bg-white text-gray-900 py-20 px-4 md:px-10">
...
<div
            ...
            >
              <h3 className="text-xl font-semibold mb-2 text-[#0A122A]">{point.title}</h3>
        ...
        <p className="mt-12 text-base md:text-lg text-gray-800 max-w-4xl mx-auto">
          ...
          monthly through freelancing, virtual assistance, content creation, and online coaching.
          Our goal is to help thousands more join them.
        </p>
      </div>
    </section>
  );
